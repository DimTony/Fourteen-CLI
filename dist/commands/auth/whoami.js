...
export function registerWhoamiCommand(program) {
    program.command("whoami").action(async () => {
        ...
        try {
            ...
            table.push([chalk.bold("Field"), chalk.bold("Value")], ["ID", userData.id || "—"], ["Username", userData.username || "—"], ["Email", userData.email || "—"], ["Role", userData.role || "—"], ["Avatar URL", userData.avatar_url || "—"]);
            console.log("\n");
